...
<div class="row-fluid">
    ...
    <div class="span5">
        ...
        <label class="control-label" for="allowed_attachments"><?php echo _('Allowed attachments file types');?><br/><i class="thirtytwo"><?php echo _('(Empty field to disable attachments in campaigns)')?></i></label>
    	<div class="control-group">
	    	<div class="controls">
        ...
        <label class="control-label" for="query_string" style="width:70%;"><?php echo _('Default URL query string');?><br/><i class="thirtytwo"><?php echo _('(Default query string to append to all links in your campaigns and autoresponders. A good use case is Google Analytics tracking. Don\'t include \'?\' in your query string.)')?></i></label>
    	<div class="control-group">
	    	<div class="controls">
