...
//get smtp settings
$q = 'SELECT smtp_host, smtp_port, smtp_ssl, smtp_username, smtp_password, notify_campaign_sent FROM apps WHERE id = '.mysqli_real_escape_string($mysqli, $_POST['app']).' AND userID = '.get_app_info('main_userID');
$r = mysqli_query($mysqli, $q);
